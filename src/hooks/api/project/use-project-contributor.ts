 ...
 *
 * The gateway may send lowercase (OpenAPI: "committed, approved")
 * or uppercase (DB: "COMMITTED, ACCEPTED"). Components
 * expect uppercase. This normalizer handles both and maps legacy values.
 *
 * DB values: COMMITTED, ACCEPTED, REFUSED, DENIED, PENDING_TX_COMMIT
 * Legacy aliases: SUBMITTED → COMMITTED, APPROVED → ACCEPTED, REJECTED → DENIED
 */
