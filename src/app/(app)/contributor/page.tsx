        ...
        return (
          <AndamioCard key={`${commitment.taskHash}-${status}`}>
            <AndamioCardHeader>
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0">
                  <AndamioCardTitle className="text-base truncate">
                    {task?.taskHash ? (
            ...
            <AndamioCardContent className="space-y-4">
              ...
              {/* ── COMMITTED (read-only, awaiting review) ──────────── */}
              {status === "COMMITTED" && (
                <>
                  <AndamioText variant="small" className="text-muted-foreground">
                  ...
                  <div className="rounded-lg border border-destructive/30 bg-destructive/5 p-3">
                    <div className="flex items-start gap-2">
                      ...
                      <AndamioText variant="small">
                        Your work needs revision. Update your evidence and resubmit.
                      </AndamioText>
                    </div>
                  </div>
              ...
              {!["COMMITTED", "REFUSED", "DENIED", "ACCEPTED", "UNKNOWN"].includes(status) &&
                !status.startsWith("PENDING_TX") && (
                  <div className="flex items-center justify-between">
                    <AndamioText variant="small" className="text-muted-foreground">
