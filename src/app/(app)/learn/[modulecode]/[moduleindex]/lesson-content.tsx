...
/**
 * Lesson detail page client content — all interactive logic lives here.
 *
 * Public data (course, modules, SLTs, lesson) is prefetched on the server
 * and hydrated into React Query's cache. The client resolves instantly.
 */
