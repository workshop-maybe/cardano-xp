...
/**
 * Tasks page client content — all interactive logic lives here.
 *
 * Public data (project, tasks) is prefetched on the server and hydrated
 * into React Query's cache, so useProject/useProjectTasks resolve instantly.
 * Auth-gated hooks fire client-side after wallet connection.
 */
